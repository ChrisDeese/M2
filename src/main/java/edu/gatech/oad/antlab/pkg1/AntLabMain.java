 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Christopher Deese");
		  toPrint += p1.toString("cdeese3");

                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
      Person2 p2 = new Person2("Prit Patel");
		  toPrint += p2.toString("ppatel301");

                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
      Person3 p3 = new Person3("Toni Johnson");
		  toPrint += p3.toString("tjohnson95");

                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jacob Watson");
                  toPrint += p4.toString("jwatson64");
